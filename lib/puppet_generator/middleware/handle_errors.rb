  ...
  module Middleware
    class HandleErrors
      ...
      def call(t)
        ...
        rescue PuppetGenerator::Exceptions::WrongViewChosen
          exit_with_error :wrong_template_chosen, command: task.meta[:command_chain].join(" "), type_of_view: task.meta[:type_of_view], destination: task.meta[:destination] 

module PuppetGenerator
  module Ui
    module CommandlineParserHelper
      ...
      @subcommand_options[:template_tagged_with] =                 { type: :string, desc: 'use the given view to render the data ' }
      @subcommand_options[:view] =                 { type: :string, desc: 'use the given view to render the data ' }

...
require 'puppet_generator/setups/list_export_filters'

describe Setups::ListExportFilters do

  let(:setup) { Setups::ListExportFilters.new }
  ...
  context "#environment" do
    it "enables all defaults" do
      ...
      expect( name_of_model_instances(:export_filter)).to eq([
        :build_role_includes_for_directory,
